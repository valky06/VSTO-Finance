...
Partial Public NotInheritable Class XLFinance
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _XLFinance As XLFinance
    ...
    Friend Shared Property XLFinance() As XLFinance
        Get
            Return _XLFinance
        End Get
        Set
            If (_XLFinance Is Nothing) Then
                _XLFinance = value
            Else
